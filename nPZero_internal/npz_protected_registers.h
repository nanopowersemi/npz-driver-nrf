/**
 * @file npz_protected_registers.h
 *
...
#ifndef __NPZ_PROTECTED_REGISTERS_H
#define __NPZ_PROTECTED_REGISTERS_H
...
typedef struct
{
    npz_register_tunlock_s tunlock;
    npz_register_tmux_s tmux;
    npz_register_rcp_trim_s rcp_trim;
    npz_register_vddd_trim_s vddd_trim;
    npz_register_vref_trim_s vref_trim;
    npz_register_vref_tc_trim_s vref_tc_trim;
    npz_register_iref_trim1_s iref_trim1;
    npz_register_iref_trim2_s iref_trim2;
    npz_register_iref_sel_s iref_sel;
    npz_register_fosc_trim_s fosc_trim;
    npz_register_sosc_trim_s sosc_trim;
    npz_register_psw_trim_s psw_trim;
    npz_register_psw_von_s psw_von;
    npz_register_xo1_s xo1;
    npz_register_xo2_s xo2;
    npz_register_test_s test;
} npz_protected_registers_s;
...
/**
 * @brief Reads the tunlock register and writes it to npz_register_tunlock_s struct.
 *
 *
...
/**
 * @brief Reads the tmux register and writes it to npz_register_tmux_s struct.
 *
 *
...
/**
 * @brief Reads the rcp_trim register and writes it to npz_register_rcp_trim_s struct.
 *
 *
...
/**
 * @brief Reads the vddd_trim register and writes it to npz_register_vddd_trim_s struct.
 *
 *
...
/**
 * @brief Reads the vref_trim register and writes it to npz_register_vref_trim_s struct.
 *
 *
...
/**
 * @brief Reads the VREF_RC_TRIM register and writes it to npz_register_vref_tc_trim_s struct.
 *
 *
...
/**
 * @brief Reads the iref_trim1 register and writes it to npz_register_iref_trim1_s struct.
 *
 *
...
/**
 * @brief Reads the iref_trim2 register and writes it to npz_register_iref_trim2_s struct.
 *
 *
...
/**
 * @brief Reads the iref_sel register and writes it to npz_register_iref_sel_s struct.
 *
 *
...
/**
 * @brief Reads the fosc_trim register and writes it to npz_register_fosc_trim_s struct.
 *
 *
...
/**
 * @brief Reads the sosc_trim register and writes it to npz_register_sosc_trim_s struct.
 *
 *
...
/**
 * @brief Reads the psw_trim register and writes it to npz_register_psw_trim_s struct.
 *
 *
...
/**
 * @brief Reads the psw_von register and writes it to npz_register_psw_von_s struct.
 *
 *
...
/**
 * @brief Reads the xo1 register and writes it to npz_register_xo1_s struct.
 *
 *
...
/**
 * @brief Reads the xo2 register and writes it to npz_register_xo2_s struct.
 *
 *
 *
 * @param [in] sw Low power switch indicates which peripheral will be read..
...
/**
 * @brief Reads the test register and writes it to npz_register_test_s struct.
 *
 *
...
#endif /* __NPZ_PROTECTED_REGISTERS_H */
